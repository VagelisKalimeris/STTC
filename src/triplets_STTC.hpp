...
*                                                                             *
******************************************************************************/
static double T_A_plus_tripl(const vector<int> &time_line_A,
                        const vector<int> &time_line_C, int total_time_samples, 
...
*                                                                             *
******************************************************************************/
static int N_BminusA_CA(const vector<int> &time_line_A, 
...
*                                                                             *
******************************************************************************/
static int N_AplusB_CA(const vector<int> &time_line_A, 
                const vector<int> &time_line_B, const vector<int> &time_line_C, 
                int Dt) __attribute__((always_inline));
...
*                                                                             *
******************************************************************************/
static double STTC_AB_C(const vector<int> &time_line_A, 
                const vector<int> &time_line_B, const vector<int> &time_line_C, 
                int Dt, double tBm, double tApt) __attribute__((always_inline));
